...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="images/asian_delight.png">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto">
              <li class="nav-item">
                <a class="nav-link menu-active" aria-current="page" href="index.php">Home</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="index.php">Services and Offers</a>
              </li>
              <li class="nav-item">
            ...
            <a class="btn btn-primary" href="index.php">Order Online</a>
